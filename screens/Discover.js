import { View, Text, SafeAreaView, Image, ActivityIndicator, ScrollView, TouchableOpacity } from 'react-native';
    ...
    <SafeAreaView className="bg-white flex-1 relative pt-10">
      ...
      <View className="flex-row items-center bg-white mx-4 rounded-xl py-1 px-4 shadow-lg">
          ...
          query={{
            ...
            key: "AIzaSyDWpuVw2apN-XqX3qmrzsHrZqr1AG4sCxQ",//fake key lol :P
            language: 'en',
          }}
        />
      </View>
          ...
          <View className="items-center px-8 mt-8 flex-row justify-between">
            ...
            <TouchableOpacity className="flex-row items-center justify-center space-x-2">
              <Text className="text-[20px] font-bold text-[#a0c4c7]" >
               ...
               <FontAwesome name="long-arrow-right" size={26} color="#a0c4c7"  />
            </TouchableOpacity>
          </View>
